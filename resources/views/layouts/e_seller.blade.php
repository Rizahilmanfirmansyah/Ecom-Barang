        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="">
                        <a href="{{route('seller.all-product')}}"><i class="menu-icon fa fa-table"></i>Semua Produk</a>
                    </li>
                    <li class="">
                        <a href="{{route('seller.add-product')}}"><i class="menu-icon fa fa-plus"></i>Tambah Produk</a>
                    </li>
