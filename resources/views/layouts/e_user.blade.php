        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active">
                        <a href="{{route('seller.all-product')}}"><i class="menu-icon fa fa-laptop"></i>Dashboard </a>
                    </li>
                    <li class="menu-title">Product</li><!-- /.menu-title -->
                    <li class="">
                        <a href="{{route('user.order')}}"><i class="menu-icon fa fa-table"></i>Pesanan</a>
                    </li>
                    <li class="">
                        <a href="{{route('user.order-ready')}}"><i class="menu-icon fa fa-plus"></i>Pesanan Siap</a>
                    </li>
                    <li class="">
                        <a href="{{route('seller.add-product')}}"><i class="menu-icon fa fa-plus"></i>Riwayat Pesanan</a>
                    </li>
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    ...
                    <a href="#" class="navbar-brand"><b style="color: #2FDBBC;">B</b>elanjaku</a>
