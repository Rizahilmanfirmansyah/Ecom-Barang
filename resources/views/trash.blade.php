    ...
    <div class="d-flex justify-content-center">
        <div class="card" style="width: 35rem;">
            ...
            <div class="card-body">
                ...
                <br>
                Mari Register <a href="{{ route('view.register')}}">User</a>
            </div>
        </div>
    </div>
</div>
...
<li data-thumb="{{ asset('assets/images/product')}}/{{$product->foto_produk}}">
    <img src="{{ asset('assets/images/product')}}/{{$product->foto_produk}}" alt="product thumbnail" />
</li>
@php
    $images = explode(',',$product->multi_images)
@endphp

@foreach ($images as $image)
@if ($image)
<li data-thumb="{{ asset('assets/images/product')}}/{{$image}}">
    <img src="{{ asset('assets/images/product')}}/{{$image}}" alt="product thumbnail" />
</li>
@endif
@endforeach
                    ...
                    <ul class="products-cart">
						<li class="pr-cart-item">
							<div class="product-image">
								<figure><img src="{{ asset('assets/images/product')}}/{{$item->model->foto_produk}}" alt=""></figure>
							</div>
							<div class="product-name">
								<a class="link-to-product" href="#">{{$item->model->nama_produk}}</a>
							</div>
							<div class="price-field produtc-price"><p class="price">{{number_format($item->model->harga_produk) ,0,",","."}}</p></div>
							<div class="quantity">
							...
							<div class="price-field sub-total"><p class="price">Rp {{number_format($item->subtotal)}}</p></div>
							<div class="delete">
