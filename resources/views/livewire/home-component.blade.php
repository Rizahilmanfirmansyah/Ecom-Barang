	...
	<div class="wrap-main-slide">
		<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
			...
			<div class="item-slide">
				<img src="{{ asset('assets/images/product')}}/{{$item->foto_produk}}" alt="" class="img-slide">
				<div class="slide-info slide-1">
					<h2 class="f-title">{{$item->nama_produk}}</h2>
					<span class="subtitle">{{$item->desk_produk}}</span>
					<p class="sale-info">Only price: <span class="price">{{$item->harga_produk}}</span></p>
			...
			<div class="product product-style-2 equal-elem">
				<div class="product-thumnail">
					<a href="detail.html" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
						<figure><img src="{{ asset('assets/images/product')}}/{{$item->foto_produk}}" style="width: 150px; height: 150px;" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
					</a>
