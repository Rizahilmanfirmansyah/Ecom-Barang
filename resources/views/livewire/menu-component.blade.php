	...
	<div class="wrap-main-slide">
		<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
			<div class="item-slide">
				<img src="{{ asset('e_user/images/main-slider-1-1.jpg')}}" alt="" class="img-slide">
			...
			<div class="item-slide">
				<img src="{{ asset('e_user/images/main-slider-1-2.jpg')}}" alt="" class="img-slide">
			...
			<div class="item-slide">
				<img src="{{ asset('e_user/images/main-slider-1-3.jpg')}}" alt="" class="img-slide">
	...
	<div class="row">
		<ul class="product-list grid-products equal-container">
			...
			{{-- <div class="card" style="width: 18rem;">
				<figure><img src="{{ asset('assets/images/product')}}/{{$product->foto_produk}}" alt="T-Shirt Raw Hem Organic Boro Constrast Denim" style="width: 250px;"></figure>
				<div class="card-body">
				  <h5 class="card-title">{{$product->nama_produk}}</h5>
				  <p class="card-text">{{$product->harga_produk}}</p>
				  <a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->id}},'{{$product->nama_produk}}',{{$product->harga_produk}})">Add To Cart</a>
				</div>
			  </div> --}}
			<li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
				<div class="product product-style-3 equal-elem ">
					<div class="product-thumnail">
						<a href="{{ route('belanja.detail',['nama_produk'=>$product->nama_produk])}}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
							<figure><img src="{{ asset('assets/images/product')}}/{{$product->foto_produk}}" alt="T-Shirt Raw Hem Organic Boro Constrast Denim" style="width: 250px; height: 150px;"></figure>
						</a>
					</div>
					<div class="product-info">
						<a href="#" class="product-name"><span>{{$product->nama_produk}}</span></a>
						<div class="wrap-price"><span class="product-price">{{$product->harga_produk}}</span></div>
						<a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->id}},'{{$product->nama_produk}}',{{$product->harga_produk}})">Add To Cart</a>
					</div>
				</div>
			</li>
